// Generated by air-to-aster pass from AIR IR analysis.
// Target: gfx942, ISA: cdna3
...
amdgcn.module @air_forward_module target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  ...
  amdgcn.kernel @forward arguments <[
    ...
    %stride_f16 = arith.constant 32 : index
    %stride_f32 = arith.constant 64 : index
    ...
    %store_tok = func.call @store_C_f32(%D, %C_ptr, %c0, %c0, %stride_f32) : (!rt_C_f32, !sx2, index, index, index) -> !write_token
