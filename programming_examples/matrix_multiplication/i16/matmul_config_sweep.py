...
DATA_FORMAT = "i16"  # e.g., "i8", "bf16", "f32", etc.

# Data format byte sizes (bytes per element)
# L1 memory calculations
INPUT_A_L1_BYTES = 2  # i16 inputs at L1
INPUT_B_L1_BYTES = 2  # i16 inputs at L1
OUTPUT_L1_BYTES = 2  # i16 output at L1

# L2 memory calculations
INPUT_A_L2_BYTES = 2  # i16 inputs at L2
INPUT_B_L2_BYTES = 2  # i16 inputs at L2
OUTPUT_L2_BYTES = 2  # i16 output at L2
