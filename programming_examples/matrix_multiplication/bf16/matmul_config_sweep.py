...
def batched(iterable):
    ...
    for row in iterable:
        ...
        if 2*(tile_m*tile_k_l2 + tile_n*tile_k_l2 + tile_m*tile_n) > 2**21: continue
...
def worker_chunk(batch):
    ...
    return [m, k, n, tile_m, tile_k_l2, tile_k_l1, tile_n, lat]
...
def main():
    ...
    with open(WRITE_FILE, 'w') as f:
        ...
        chunk_iter = batched(product([SIZE], [SIZE], [SIZE], tile_m_vals, tile_k_l2_vals, tile_k_l1_vals, tile_n_vals))
