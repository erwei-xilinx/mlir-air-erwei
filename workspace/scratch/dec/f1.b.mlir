module attributes {gpu.container_module} {
  ...
  gpu.module @chain_module {
    gpu.func @chain_module(%arg0: memref<737xi32>, %arg1: memref<23xi32>, %arg2: memref<1xi32>, %arg3: memref<1x2x224xi32>, %arg4: memref<6xi32>, %arg5: memref<256x128xf32>, %arg6: memref<5x128xf32>, %arg7: memref<2x128xf32>, %arg8: memref<5x128xf32>, %arg9: memref<2x128x256xf32>, %arg10: memref<5x256xf32>, %arg11: memref<2x64xf32>, %arg12: memref<37x64xf32>, %arg13: memref<2x37x2x32xf32>, %arg14: memref<2x37x2x32xf32>, %arg15: memref<5x4x37xf32>, %arg16: memref<5x128xf32>, %arg17: memref<2x128x128xf32>, %arg18: memref<5x128xf32>, %arg19: memref<5x128xf32>, %arg20: memref<2x128xf32>, %arg21: memref<2x128x512xf32>, %arg22: memref<5x512xf32>, %arg23: memref<5x256xf32>, %arg24: memref<2x256x128xf32>, %arg25: memref<128xf32>, %arg26: memref<128x256xf32>, %arg27: memref<5x256xf32>, %arg28: memref<5x8xf32>, %arg29: memref<5x8xi32>) kernel attributes {known_block_size = array<i32: 64, 1, 1>, known_grid_size = array<i32: 32, 1, 1>} {
      %c144 = arith.constant 144 : index
      %c24_i64 = arith.constant 24 : i64
      %c80 = arith.constant 80 : index
      %cst = arith.constant -1.000000e+30 : f32
    ...
    ^bb10:  // pred: ^bb8
      ...
      %intptr_21 = memref.extract_aligned_pointer_as_index %arg0 : memref<737xi32> -> index
      %45 = arith.index_cast %intptr_21 : index to i64
      %46 = llvm.inttoptr %45 : i64 to !llvm.ptr
      %47 = llvm.getelementptr %46[2944] : (!llvm.ptr) -> !llvm.ptr, i8
      %48 = arith.index_cast %28 : index to i32
      %intptr_22 = memref.extract_aligned_pointer_as_index %arg1 : memref<23xi32> -> index
    ...
    ^bb17(%75: i1, %76: i32):  // pred: ^bb16
      %77 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %72] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb19:  // pred: ^bb18
      ...
      %86 = memref.load %arg4[%85] : memref<6xi32>
    ...
    ^bb28:  // pred: ^bb14
      ...
      %102 = arith.addi %100, %c1472_i64 : i64
    ...
    ^bb32:  // pred: ^bb31
      ...
      %114 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %c0] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb49(%149: i1, %150: i32):  // pred: ^bb48
      %151 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %146] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb63:  // pred: ^bb46
      ...
      %180 = arith.addi %178, %c1472_i64 : i64
    ...
    ^bb71(%201: i1, %202: i32):  // pred: ^bb70
      %203 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %198] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb82:  // pred: ^bb81
      ...
      %240 = memref.load %arg12[%212, %233] : memref<37x64xf32>
      %241 = arith.addi %233, %c32 : index
      %242 = memref.load %arg12[%212, %241] : memref<37x64xf32>
    ...
    ^bb93:  // pred: ^bb92
      ...
      %280 = memref.load %arg12[%212, %273] : memref<37x64xf32>
      %281 = arith.addi %273, %c32 : index
      %282 = memref.load %arg12[%212, %281] : memref<37x64xf32>
    ...
    ^bb96:  // pred: ^bb95
      ...
      memref.store %294, %arg13[%c0, %211, %208, %291] : memref<2x37x2x32xf32>
      %295 = arith.addi %290, %291 : index
      %296 = memref.load %arg10[%205, %295] : memref<5x256xf32>
      memref.store %296, %arg14[%c0, %211, %208, %291] : memref<2x37x2x32xf32>
    ...
    ^bb104:  // pred: ^bb68
      ...
      %306 = arith.addi %304, %c1472_i64 : i64
    ...
    ^bb112(%327: i1, %328: i32):  // pred: ^bb111
      %329 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %324] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb116:  // pred: ^bb115
      cf.br ^bb117(%c0, %cst_1 : index, f32)
    ...
    ^bb118:  // pred: ^bb117
      ...
      %349 = memref.load %arg13[%c0, %341, %340, %344] {nontemporal = true} : memref<2x37x2x32xf32>
    ...
    ^bb125:  // pred: ^bb124
      cf.br ^bb126(%c0, %cst_1 : index, f32)
    ^bb126(%368: index, %369: f32):  // 2 preds: ^bb125, ^bb127
      %370 = arith.cmpi slt, %368, %64 : index
      cf.cond_br %370, ^bb127, ^bb128
    ^bb127:  // pred: ^bb126
      %371 = memref.load %arg15[%331, %334, %368] : memref<5x4x37xf32>
      %372 = arith.divf %371, %359 : f32
      %373 = memref.load %arg14[%c0, %368, %340, %366] {nontemporal = true} : memref<2x37x2x32xf32>
    ...
    ^bb135:  // pred: ^bb109
      ...
      %387 = arith.addi %385, %c1472_i64 : i64
    ...
    ^bb143(%408: i1, %409: i32):  // pred: ^bb142
      %410 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %405] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb147:  // pred: ^bb146
      ...
      cf.br ^bb148(%c0, %cst_1 : index, f32)
    ...
    ^bb157:  // pred: ^bb140
      ...
      %439 = arith.addi %437, %c1472_i64 : i64
    ...
    ^bb161:  // pred: ^bb160
      ...
      %452 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %c80] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb164:  // pred: ^bb163
      cf.br ^bb165(%c0, %cst_1 : index, f32)
    ...
    ^bb178(%489: i1, %490: i32):  // pred: ^bb177
      %491 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %486] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb182:  // pred: ^bb181
      ...
      cf.br ^bb183(%c0, %cst_1 : index, f32)
    ...
    ^bb192:  // pred: ^bb175
      ...
      %520 = arith.addi %518, %c1472_i64 : i64
    ...
    ^bb200(%541: i1, %542: i32):  // pred: ^bb199
      %543 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %538] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb211:  // pred: ^bb197
      ...
      %572 = arith.addi %570, %c1472_i64 : i64
    ...
    ^bb219(%593: i1, %594: i32):  // pred: ^bb218
      %595 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %590] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb223:  // pred: ^bb222
      ...
      cf.br ^bb224(%c0, %cst_1 : index, f32)
    ...
    ^bb233:  // pred: ^bb216
      ...
      %626 = arith.addi %624, %c1472_i64 : i64
    ...
    ^bb237:  // pred: ^bb236
      ...
      %639 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %c0] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb240:  // pred: ^bb239
      cf.br ^bb241(%c0, %cst_1 : index, f32)
    ...
    ^bb254(%674: i1, %675: i32):  // pred: ^bb253
      %676 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %671] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb258:  // pred: ^bb257
      ...
      cf.br ^bb259(%c0, %cst_1 : index, f32)
    ...
    ^bb268:  // pred: ^bb251
      ...
      %705 = arith.addi %703, %c1472_i64 : i64
    ...
    ^bb276(%726: i1, %727: i32):  // pred: ^bb275
      %728 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %723] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb278:  // pred: ^bb277
      ...
      cf.br ^bb279
    ^bb279:  // pred: ^bb278
      cf.br ^bb280(%c0, %cst_1 : index, f32)
    ...
    ^bb287:  // pred: ^bb286
      ...
      %765 = memref.load %arg12[%737, %758] : memref<37x64xf32>
      %766 = arith.addi %758, %c32 : index
      %767 = memref.load %arg12[%737, %766] : memref<37x64xf32>
    ...
    ^bb290:  // pred: ^bb289
      ...
      cf.br ^bb291(%c0, %cst_1 : index, f32)
    ...
    ^bb298:  // pred: ^bb297
      ...
      %805 = memref.load %arg12[%737, %798] : memref<37x64xf32>
      %806 = arith.addi %798, %c32 : index
      %807 = memref.load %arg12[%737, %806] : memref<37x64xf32>
    ...
    ^bb301:  // pred: ^bb300
      ...
      memref.store %819, %arg13[%c1, %736, %733, %816] : memref<2x37x2x32xf32>
      %820 = arith.addi %815, %816 : index
      %821 = memref.load %arg10[%730, %820] : memref<5x256xf32>
      memref.store %821, %arg14[%c1, %736, %733, %816] : memref<2x37x2x32xf32>
    ...
    ^bb309:  // pred: ^bb273
      ...
      %831 = arith.addi %829, %c1472_i64 : i64
    ...
    ^bb317(%852: i1, %853: i32):  // pred: ^bb316
      %854 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %849] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb321:  // pred: ^bb320
      cf.br ^bb322(%c0, %cst_1 : index, f32)
    ...
    ^bb323:  // pred: ^bb322
      ...
      %874 = memref.load %arg13[%c1, %866, %865, %869] {nontemporal = true} : memref<2x37x2x32xf32>
    ...
    ^bb330:  // pred: ^bb329
      cf.br ^bb331(%c0, %cst_1 : index, f32)
    ^bb331(%893: index, %894: f32):  // 2 preds: ^bb330, ^bb332
      %895 = arith.cmpi slt, %893, %64 : index
      cf.cond_br %895, ^bb332, ^bb333
    ^bb332:  // pred: ^bb331
      %896 = memref.load %arg15[%856, %859, %893] : memref<5x4x37xf32>
      %897 = arith.divf %896, %884 : f32
      %898 = memref.load %arg14[%c1, %893, %865, %891] {nontemporal = true} : memref<2x37x2x32xf32>
    ...
    ^bb340:  // pred: ^bb314
      ...
      %912 = arith.addi %910, %c1472_i64 : i64
    ...
    ^bb348(%933: i1, %934: i32):  // pred: ^bb347
      %935 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %930] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb352:  // pred: ^bb351
      ...
      cf.br ^bb353(%c0, %cst_1 : index, f32)
    ...
    ^bb362:  // pred: ^bb345
      ...
      %964 = arith.addi %962, %c1472_i64 : i64
    ...
    ^bb366:  // pred: ^bb365
      ...
      %977 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %c80] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb369:  // pred: ^bb368
      cf.br ^bb370(%c0, %cst_1 : index, f32)
    ...
    ^bb383(%1014: i1, %1015: i32):  // pred: ^bb382
      %1016 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %1011] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb387:  // pred: ^bb386
      ...
      cf.br ^bb388(%c0, %cst_1 : index, f32)
    ...
    ^bb397:  // pred: ^bb380
      ...
      %1045 = arith.addi %1043, %c1472_i64 : i64
    ...
    ^bb405(%1066: i1, %1067: i32):  // pred: ^bb404
      %1068 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %1063] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb409:  // pred: ^bb408
      ...
      %1085 = arith.addf %1084, %cst_0 : f32
    ...
    ^bb416:  // pred: ^bb402
      ...
      %1097 = arith.addi %1095, %c1472_i64 : i64
    ...
    ^bb424(%1118: i1, %1119: i32):  // pred: ^bb423
      %1120 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c1, %1115] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb428:  // pred: ^bb427
      ...
      cf.br ^bb429(%c0, %cst_1 : index, f32)
    ...
    ^bb438:  // pred: ^bb421
      ...
      %1151 = arith.addi %1149, %c1472_i64 : i64
    ...
    ^bb442:  // pred: ^bb441
      ...
      %1164 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %c160] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb445:  // pred: ^bb444
      cf.br ^bb446(%c0, %cst_1 : index, f32)
    ...
    ^bb448:  // pred: ^bb446
      %1175 = arith.divf %1169, %cst_3 : f32
    ...
    ^bb459(%1199: i1, %1200: i32):  // pred: ^bb458
      %1201 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %1196] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb463:  // pred: ^bb462
      ...
      cf.br ^bb464(%c0, %cst_1 : index, f32)
    ...
    ^bb473:  // pred: ^bb456
      ...
      %1230 = arith.addi %1228, %c1472_i64 : i64
    ...
    ^bb481(%1251: i1, %1252: i32):  // pred: ^bb480
      %1253 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %1248] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb492:  // pred: ^bb478
      ...
      %1281 = arith.addi %1279, %c1472_i64 : i64
    ...
    ^bb496:  // pred: ^bb495
      ...
      %1294 = memref.atomic_rmw addi %c1_i32, %arg3[%51, %c0, %c208] : (i32, memref<1x2x224xi32>) -> i32
    ...
    ^bb504:  // pred: ^bb503
      memref.store %1300, %arg4[%1310] : memref<6xi32>
      cf.br ^bb505
