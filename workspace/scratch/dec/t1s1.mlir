module {
  ...
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %c6_25 step %c1 {
      %7 = arith.index_cast %arg0 : index to i32
    ...
    %0 = scf.for %arg0 = %c0 to %c3 step %c1 iter_args(%arg1 = %c0) -> (index) {
      ...
      scf.for %arg2 = %c0 to %10 step %c1 {
        ...
        scf.if %20 {
          ...
          %22 = arith.cmpi sge, %21, %c6_25 : index
          scf.if %22 {
    ...
    scf.for %arg0 = %c0 to %c1_111 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c7 step %c1 {
        %7 = arith.cmpi ult, %arg1, %c6_25 : index
    ...
    %3 = scf.for %arg0 = %c6_25 to %c7 step %c1 iter_args(%arg1 = %c0_i32) -> (i32) {
    ...
    scf.for %arg0 = %c6_25 to %c7 step %c1 {
