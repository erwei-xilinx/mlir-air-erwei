module attributes {gpu.container_module} {
  ...
  gpu.module @chain_module {
    gpu.func @chain_module(%arg0: memref<2945xi32>, %arg1: memref<92xi32>, %arg2: memref<1xi32>, %arg3: memref<4x2x224xi32>, %arg4: memref<9xi32>, %arg5: memref<256x128xf32>, %arg6: memref<2x128xf32>, %arg7: memref<2x128xf32>, %arg8: memref<2x128xf32>, %arg9: memref<2x128x256xf32>, %arg10: memref<2x256xf32>, %arg11: memref<2x64xf32>, %arg12: memref<40x64xf32>, %arg13: memref<2x40x2x32xf32>, %arg14: memref<2x40x2x32xf32>, %arg15: memref<2x4x40xf32>, %arg16: memref<2x128xf32>, %arg17: memref<2x128x128xf32>, %arg18: memref<2x128xf32>, %arg19: memref<2x128xf32>, %arg20: memref<2x128xf32>, %arg21: memref<2x128x512xf32>, %arg22: memref<2x512xf32>, %arg23: memref<2x256xf32>, %arg24: memref<2x256x128xf32>, %arg25: memref<128xf32>, %arg26: memref<128x256xf32>, %arg27: memref<2x256xf32>, %arg28: memref<2x8xf32>, %arg29: memref<2x8xi32>) kernel attributes {known_block_size = array<i32: 64, 1, 1>, known_grid_size = array<i32: 32, 1, 1>} {
      ...
      %c0_i32 = arith.constant 0 : i32
      %c704_i64 = arith.constant 704 : i64
      %cst_3 = arith.constant 0.176776692 : f32
      %c176 = arith.constant 176 : index
      %c96 = arith.constant 96 : index
      %c16_i32 = arith.constant 16 : i32
      %c32 = arith.constant 32 : index
      ...
      %c256_i64 = arith.constant 256 : i64
      %cst_5 = arith.constant 3.200000e+01 : f32
      %c208 = arith.constant 208 : index
      %c1280_i64 = arith.constant 1280 : i64
      %c1 = arith.constant 1 : index
      %c44_i64 = arith.constant 44 : i64
    ...
    ^bb38:  // pred: ^bb36
      %125 = arith.divf %119, %cst_4 : f32
      %126 = arith.addf %125, %cst_0 : f32
    ...
    ^bb88:  // pred: ^bb86
      %261 = arith.divf %254, %cst_5 : f32
      %262 = arith.addf %261, %cst_0 : f32
    ...
    ^bb114:  // pred: ^bb113
      ...
      cf.br ^bb115(%c0, %cst_1 : index, f32)
    ...
    ^bb119:  // pred: ^bb117
      %353 = arith.mulf %345, %cst_3 : f32
      %354 = arith.cmpi ule, %341, %337 : index
      %355 = arith.select %354, %353, %cst_1 : f32
    ...
    ^bb167:  // pred: ^bb165
      %465 = arith.divf %457, %cst_4 : f32
      %466 = arith.addf %465, %cst_0 : f32
    ...
    ^bb243:  // pred: ^bb241
      %650 = arith.divf %644, %cst_4 : f32
      %651 = arith.addf %650, %cst_0 : f32
    ...
    ^bb282:  // pred: ^bb280
      %747 = arith.divf %740, %cst_5 : f32
      %748 = arith.addf %747, %cst_0 : f32
    ...
    ^bb293:  // pred: ^bb291
      %786 = arith.divf %779, %cst_5 : f32
      %787 = arith.addf %786, %cst_0 : f32
    ...
    ^bb319:  // pred: ^bb318
      ...
      cf.br ^bb320(%c0, %cst_1 : index, f32)
    ...
    ^bb324:  // pred: ^bb322
      %878 = arith.mulf %870, %cst_3 : f32
      %879 = arith.cmpi ule, %866, %862 : index
      %880 = arith.select %879, %878, %cst_1 : f32
    ...
    ^bb372:  // pred: ^bb370
      %990 = arith.divf %982, %cst_4 : f32
      %991 = arith.addf %990, %cst_0 : f32
    ...
    ^bb409:  // pred: ^bb408
      ...
      %1085 = arith.addf %1084, %cst_2 : f32
    ...
    ^bb448:  // pred: ^bb446
      %1175 = arith.divf %1169, %cst_4 : f32
      %1176 = arith.addf %1175, %cst_0 : f32
    ...
    ^bb483:  // pred: ^bb482
      ...
      cf.br ^bb484(%c0, %cst_1, %c0_i32 : index, f32, i32)
    ...
    ^bb499:  // pred: ^bb498
      cf.br ^bb500(%c0, %cst_1, %c0_i32 : index, f32, i32)
    ...
    ^bb502:  // pred: ^bb500
      %1308 = arith.cmpi eq, %1296, %c0 : index
      cf.cond_br %1308, ^bb503, ^bb506
    ^bb503:  // pred: ^bb502
      %1309 = arith.addi %52, %62 : index
      %1310 = arith.cmpi sge, %1309, %58 : index
      cf.cond_br %1310, ^bb504, ^bb505
    ^bb504:  // pred: ^bb503
      memref.store %1300, %arg4[%1309] : memref<9xi32>
      cf.br ^bb505
    ^bb505:  // 2 preds: ^bb503, ^bb504
      cf.br ^bb506
    ^bb506:  // 2 preds: ^bb502, ^bb505
      %1311 = arith.addi %1296, %c1 : index
      cf.br ^bb498(%1311 : index)
    ^bb507:  // pred: ^bb498
      %1312 = llvm.atomicrmw add %1293, %c1_i32 syncscope("") release : !llvm.ptr, i32
      cf.br ^bb508
    ^bb508:  // 2 preds: ^bb496, ^bb507
      cf.br ^bb509
    ^bb509:  // 2 preds: ^bb508, ^bb509
      %1313 = llvm.load %1293 atomic syncscope("") acquire {alignment = 4 : i64} : !llvm.ptr -> i32
      %1314 = arith.cmpi ult, %1313, %c1_i32 : i32
      cf.cond_br %1314, ^bb509, ^bb510
    ^bb510:  // pred: ^bb509
      %1315 = arith.addi %52, %62 : index
      %1316 = arith.addi %51, %c1 : index
      cf.br ^bb12(%1316, %1315 : index, index)
    ^bb511:  // pred: ^bb12
      cf.br ^bb512
