module attributes {gpu.container_module} {
  ...
  func.func @main() {
    ...
    memref.store %c6_i32, %alloc_56[%c0] : memref<1xi32>
    cf.br ^bb1(%c0 : index)
  ...
  ^bb64(%158: index):  // 2 preds: ^bb63, ^bb65
    %159 = arith.cmpi slt, %158, %c6 : index
  ...
  ^bb308:  // pred: ^bb307
    ...
    %693 = arith.cmpi sge, %692, %c6 : index
  ...
  ^bb371:  // pred: ^bb370
    %756 = arith.cmpi ult, %754, %c6 : index
  ...
  ^bb379:  // pred: ^bb374
    ...
    cf.br ^bb380(%c6, %c0_i32 : index, i32)
